...
de:{
  ...
  f_copy_hint_window:"Kopiert Stellungen, Bedingungen, den Bereich und den Regen-, Wind- und Frostschutz. Fenster-Entität und Name bleiben unverändert.",
  ...
  f_copy_from:"Einstellungen übernehmen von",f_copy_pick:"– Rollladen wählen –",f_copy_btn:"Übernehmen",f_copy_hint:"Kopiert Positionen, Lamellen, Beschattung, Bedingungen, Bereiche und Fenster-Einstellungen. Cover-Entität, Name und Fenstersensoren bleiben unverändert.",
  ...
  f_drive_after:"Nachholen wenn Fenster offen oder gekippt",
  f_drive_after_hint:"Wenn die Schließzeit erreicht wird, das Fenster aber offen oder gekippt ist, wird die Fahrt nachgeholt, sobald es geschlossen wird. Ohne den Haken darunter fährt der Rollladen bis dahin gar nicht.",
  ...
  f_copy_hint_awning:"Kopiert Positionen, Ausfahrlänge, Beschattung, Bedingungen, den Beschattungsbereich und den Wind- und Regenschutz. Cover-Entität und Name bleiben unverändert.",
  ...
  f_vent_while_open:"Bei offenem oder gekipptem Fenster schon auf die Lüftungsposition fahren",
  f_vent_while_open_hint:"Ohne diesen Haken bleibt der Rollladen stehen, wo er ist, solange das Fenster offen oder gekippt ist. Mit ihm fährt er auf die Position für „offen“ bzw. „gekippt“, so weit es der Aussperrschutz zulässt; die volle Fahrt bleibt vorgemerkt.",
...
en:{
  ...
  f_copy_hint_window:"Copies positions, conditions, the area and the rain, wind and frost protection. Window entity and name are left alone.",
  ...
  f_copy_from:"Copy settings from",f_copy_pick:"– choose a shutter –",f_copy_btn:"Apply",f_copy_hint:"Copies positions, slats, shading, conditions, areas and window settings. Cover entity, name and window sensors are left alone.",
  ...
  f_drive_after:"Catch up when window open or tilted",
  f_drive_after_hint:"When close time is reached but the window is open or tilted, the drive is executed as soon as it is closed. Without the checkbox below, the shutter does not move at all until then.",
  ...
  f_copy_hint_awning:"Copies positions, extension, shading, conditions, the shading area and the wind and rain protection. Cover entity and name are left alone.",
  ...
  f_vent_while_open:"Move to the ventilation position while the window is open or tilted",
  f_vent_while_open_hint:"Without this the shutter stays where it is while the window is open or tilted. With it, it moves to the position for “open” or “tilted”, as far as the lock protection allows; the full drive stays pending.",
...
fr:{
  ...
  f_copy_hint_window:"Copie positions, conditions, la zone et la protection pluie, vent et gel. Entité et nom restent inchangés.",
  ...
  f_copy_from:"Reprendre les réglages de",f_copy_pick:"– choisir un volet –",f_copy_btn:"Appliquer",f_copy_hint:"Copie positions, lamelles, ombrage, conditions, zones et réglages de fenêtre. Entité, nom et capteurs restent inchangés.",
  ...
  f_drive_after:"Rattraper si fenêtre ouverte ou entrebâillée",f_drive_after_hint:"Si l'heure de fermeture arrive alors que la fenêtre est ouverte ou entrebâillée, la course est rattrapée dès sa fermeture. Sans l'option ci-dessous, le volet ne bouge pas du tout jusque-là.",
  ...
  f_copy_hint_awning:"Copie positions, déploiement, ombrage, conditions, la zone d'ombrage et la protection vent et pluie. Entité et nom restent inchangés.",
  ...
  f_vent_while_open:"Aller à la position d'aération quand la fenêtre est ouverte ou entrebâillée",
  f_vent_while_open_hint:"Sans cette option, le volet reste où il est tant que la fenêtre est ouverte ou entrebâillée. Avec elle, il va à la position « ouverte » ou « entrebâillée », autant que la protection anti-enfermement le permet ; la course complète reste en attente.",
...
es:{
  ...
  f_copy_hint_window:"Copia posiciones, condiciones, la zona y la protección de lluvia, viento y helada. Entidad y nombre no cambian.",
  ...
  f_copy_from:"Copiar ajustes de",f_copy_pick:"– elegir persiana –",f_copy_btn:"Aplicar",f_copy_hint:"Copia posiciones, lamas, sombreado, condiciones, zonas y ajustes de ventana. Entidad, nombre y sensores no cambian.",
  ...
  f_drive_after:"Recuperar si ventana abierta o basculante",f_drive_after_hint:"Si llega la hora de cierre con la ventana abierta o basculante, el recorrido se ejecuta en cuanto se cierre. Sin la opción de abajo, la persiana no se mueve nada hasta entonces.",
  ...
  f_copy_hint_awning:"Copia posiciones, extensión, sombreado, condiciones, la zona de sombreado y la protección de viento y lluvia. Entidad y nombre no se tocan.",
  ...
  f_vent_while_open:"Ir a la posición de ventilación con la ventana abierta o basculante",
  f_vent_while_open_hint:"Sin esta opción la persiana se queda donde está mientras la ventana esté abierta o basculante. Con ella va a la posición de «abierta» o «basculante», hasta donde permite la protección antibloqueo; el recorrido completo queda pendiente.",
...
it:{
  ...
  f_copy_hint_window:"Copia posizioni, condizioni, l'area e la protezione pioggia, vento e gelo. Entità e nome restano invariati.",
  ...
  f_copy_from:"Copia impostazioni da",f_copy_pick:"– scegli tapparella –",f_copy_btn:"Applica",f_copy_hint:"Copia posizioni, lamelle, ombreggiatura, condizioni, aree e impostazioni finestra. Entità, nome e sensori restano invariati.",
  ...
  f_drive_after:"Recupera se finestra aperta o a vasistas",f_drive_after_hint:"Se arriva l'ora di chiusura con la finestra aperta o a vasistas, la corsa viene recuperata appena la finestra si chiude. Senza l'opzione qui sotto la tapparella non si muove affatto fino ad allora.",
  ...
  f_copy_hint_awning:"Copia posizioni, estensione, ombreggiatura, condizioni, la zona di ombreggiatura e la protezione vento e pioggia. Entità e nome restano invariati.",
  ...
  f_vent_while_open:"Andare in posizione di aerazione con la finestra aperta o a vasistas",
  f_vent_while_open_hint:"Senza questa opzione la tapparella resta dov'è finché la finestra è aperta o a vasistas. Con essa va alla posizione «aperta» o «a vasistas», per quanto consente la protezione antichiusura; la corsa completa resta in attesa.",
...
nl:{
  ...
  f_copy_hint_window:"Kopieert standen, voorwaarden, het gebied en de regen-, wind- en vorstbeveiliging. Entiteit en naam blijven ongewijzigd.",
  ...
  f_copy_from:"Instellingen overnemen van",f_copy_pick:"– rolluik kiezen –",f_copy_btn:"Toepassen",f_copy_hint:"Kopieert posities, lamellen, zonwering, voorwaarden, gebieden en raaminstellingen. Entiteit, naam en sensoren blijven ongewijzigd.",
  ...
  f_drive_after:"Inhalen als raam open of gekiept",f_drive_after_hint:"Als de sluitingstijd bereikt wordt maar het raam open of gekiept staat, wordt de rit ingehaald zodra het raam gesloten wordt. Zonder het vinkje hieronder beweegt het rolluik tot dan helemaal niet.",
  ...
  f_copy_hint_awning:"Kopieert posities, uitschuiflengte, schaduw, voorwaarden, de schaduwzone en de wind- en regenbeveiliging. Entiteit en naam blijven ongewijzigd.",
  ...
  f_vent_while_open:"Bij open of gekiept raam alvast naar de ventilatiestand rijden",
  f_vent_while_open_hint:"Zonder dit vinkje blijft het rolluik staan waar het staat zolang het raam open of gekiept is. Met vinkje gaat het naar de stand voor „open“ of „gekiept“, zo ver als de buitensluitbeveiliging toelaat; de volledige rit blijft gepland.",
...
da:{
  ...
  f_copy_hint_window:"Kopierer positioner, betingelser, området og regn-, vind- og frostbeskyttelsen. Enhed og navn forbliver uændret.",
  ...
  f_copy_from:"Kopiér indstillinger fra",f_copy_pick:"– vælg rullegardin –",f_copy_btn:"Anvend",f_copy_hint:"Kopierer positioner, lameller, afskærmning, betingelser, områder og vinduesindstillinger. Entitet, navn og sensorer ændres ikke.",
  ...
  f_drive_after:"Indhent hvis vindue åbent eller på klem",f_drive_after_hint:"Hvis lukketiden nås, mens vinduet står åbent eller på klem, indhentes kørslen, så snart vinduet lukkes. Uden fluebenet nedenfor bevæger rullegardinet sig slet ikke indtil da.",
  ...
  f_copy_hint_awning:"Kopierer positioner, udkørsel, skygge, betingelser, skyggeområdet og vind- og regnbeskyttelsen. Entitet og navn forbliver uændret.",
  ...
  f_vent_while_open:"Kør til udluftningsposition, mens vinduet er åbent eller på klem",
  f_vent_while_open_hint:"Uden dette flueben bliver rullegardinet stående, så længe vinduet er åbent eller på klem. Med det kører det til positionen for „åbent“ eller „på klem“, så langt som udelukkelsesbeskyttelsen tillader; den fulde kørsel forbliver planlagt.",
...
sv:{
  ...
  f_copy_hint_window:"Kopierar lägen, villkor, området och regn-, vind- och frostskyddet. Entitet och namn lämnas orörda.",
  ...
  f_copy_from:"Kopiera inställningar från",f_copy_pick:"– välj jalusi –",f_copy_btn:"Använd",f_copy_hint:"Kopierar positioner, lameller, solskydd, villkor, områden och fönsterinställningar. Entitet, namn och sensorer lämnas orörda.",
  ...
  f_drive_after:"Hämta om fönster öppet eller på glänt",f_drive_after_hint:"Om stängningstiden nås medan fönstret står öppet eller på glänt körs körningen i kapp så snart fönstret stängs. Utan bocken nedanför rör sig persiennen inte alls fram till dess.",
  ...
  f_copy_hint_awning:"Kopierar positioner, utfällning, skugga, villkor, skuggområdet och vind- och regnskyddet. Entitet och namn lämnas orörda.",
  ...
  f_vent_while_open:"Kör till vädringsläget medan fönstret står öppet eller på glänt",
  f_vent_while_open_hint:"Utan den här bocken står persiennen kvar så länge fönstret är öppet eller på glänt. Med den går den till läget för ”öppet” eller ”på glänt”, så långt som utelåsningsskyddet tillåter; hela körningen är fortfarande inplanerad.",
...
pl:{
  ...
  f_copy_hint_window:"Kopiuje położenia, warunki, obszar oraz ochronę przed deszczem, wiatrem i mrozem. Encja i nazwa pozostają bez zmian.",
  ...
  f_copy_from:"Skopiuj ustawienia z",f_copy_pick:"– wybierz roletę –",f_copy_btn:"Zastosuj",f_copy_hint:"Kopiuje pozycje, lamele, zacienienie, warunki, obszary i ustawienia okna. Encja, nazwa i czujniki pozostają bez zmian.",
  ...
  f_drive_after:"Nadrobić gdy okno otwarte lub uchylone",f_drive_after_hint:"Jeśli pora zamknięcia nadejdzie przy oknie otwartym lub uchylonym, przejazd zostanie nadrobiony zaraz po zamknięciu okna. Bez opcji poniżej roleta do tego czasu w ogóle się nie porusza.",
  ...
  f_copy_hint_awning:"Kopiuje położenia, wysunięcie, zacienienie, warunki, strefę zacienienia oraz ochronę przed wiatrem i deszczem. Encja i nazwa pozostają bez zmian.",
  ...
  f_vent_while_open:"Przy otwartym lub uchylonym oknie zjechać do pozycji wietrzenia",
  f_vent_while_open_hint:"Bez tej opcji roleta stoi tam, gdzie jest, dopóki okno jest otwarte lub uchylone. Z nią zjeżdża do pozycji dla „otwarte“ lub „uchylone“, tak nisko, jak pozwala ochrona przed zatrzaśnięciem; pełny przejazd pozostaje zaplanowany.",
...
pt:{
  ...
  f_copy_hint_window:"Copia posições, condições, a área e a proteção de chuva, vento e geada. Entidade e nome ficam inalterados.",
  ...
  f_copy_from:"Copiar definições de",f_copy_pick:"– escolher estore –",f_copy_btn:"Aplicar",f_copy_hint:"Copia posições, lâminas, sombreamento, condições, áreas e definições de janela. Entidade, nome e sensores ficam iguais.",
  ...
  f_drive_after:"Recuperar se janela aberta ou basculante",f_drive_after_hint:"Se a hora de fecho chegar com a janela aberta ou basculante, o percurso é recuperado assim que a janela for fechada. Sem a opção abaixo o estore não se move de todo até lá.",
  ...
  f_copy_hint_awning:"Copia posições, extensão, sombreamento, condições, a zona de sombreamento e a proteção de vento e chuva. Entidade e nome ficam inalterados.",
  ...
  f_vent_while_open:"Ir para a posição de ventilação com a janela aberta ou basculante",
  f_vent_while_open_hint:"Sem esta opção o estore fica onde está enquanto a janela estiver aberta ou basculante. Com ela vai para a posição de «aberta» ou «basculante», até onde a proteção anti-bloqueio permite; o percurso completo fica pendente.",
...
nb:{
  ...
  f_copy_hint_window:"Kopierer posisjoner, betingelser, området og regn-, vind- og frostbeskyttelsen. Entitet og navn forblir uendret.",
  ...
  f_copy_from:"Kopier innstillinger fra",f_copy_pick:"– velg rullegardin –",f_copy_btn:"Bruk",f_copy_hint:"Kopierer posisjoner, lameller, solskjerming, betingelser, områder og vindusinnstillinger. Entitet, navn og sensorer endres ikke.",
  ...
  f_drive_after:"Ta igjen hvis vindu åpent eller på gløtt",f_drive_after_hint:"Hvis lukketiden nås mens vinduet står åpent eller på gløtt, tas kjøringen igjen så snart vinduet lukkes. Uten haken nedenfor beveger rullegardinen seg ikke i det hele tatt fram til da.",
  ...
  f_copy_hint_awning:"Kopierer posisjoner, utkjøring, skygge, betingelser, skyggeområdet og vind- og regnbeskyttelsen. Entitet og navn forblir uendret.",
  ...
  f_vent_while_open:"Kjør til luftestillingen mens vinduet står åpent eller på gløtt",
  f_vent_while_open_hint:"Uten denne haken blir rullegardinen stående så lenge vinduet er åpent eller på gløtt. Med den kjører den til stillingen for «åpent» eller «på gløtt», så langt som utelåsingsvernet tillater; hele kjøringen forblir planlagt.",
...
class ShutterPilotPanel extends PanelBase {
  ...
  /* Die Bereiche werden seit 2.21.2 *mit* kopiert. Frueher blieben sie aussen
     vor, mit der Begruendung, genau sie unterschieden zwei sonst gleiche
     Rollladen. In der Praxis ist es umgekehrt: wer "Einstellungen uebernehmen
     von X" drueckt, will einen zweiten Rollladen wie X – und der haengt fast
     immer an denselben Bereichen (TanjaHH). Entitaet und Name bleiben ohnehin
     verschieden, das genuegt zur Unterscheidung. */
  static get COPY_KEEP(){return ["cover_entity_id","name",
