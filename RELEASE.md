...
1. **manifest.json**  
   ...
   → `"version": "1.4.0"` (neue Version eintragen)
...
3. **Commit erstellen**  
   - Unten links: Commit-Nachricht, z.B.:  
     `Release v1.4.0: Einrichtung vereinfacht, HACS-Infos ergänzt`
...
3. **Tag erstellen**  
   - **Choose a tag:** `v1.4.0` eingeben  
   - Wenn der Tag noch nicht existiert: **„+ Create new tag: v1.4.0 on publish“** wählen  
   - **Target:** `master` (oder dein Standard-Branch)

4. **Release-Titel**  
   z.B.: `Shutter Pilot v1.4.0`
...
- **Version:** Die Tag-Bezeichnung (z.B. `v1.4.0`) ist die Versionsnummer in HACS
